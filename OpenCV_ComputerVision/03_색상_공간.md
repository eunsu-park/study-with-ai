...
[04_기하학적_변환.md](./04_기하학적_변환.md)에서 이미지 크기 조절, 회전, 뒤집기, 어파인/원근 변환 등을 학습합니다!
...
| 폴더 | 관련 내용 |
|------|----------|
| [02_이미지_기초_연산.md](./02_이미지_기초_연산.md) | 이미지 읽기, 픽셀 접근 |
| [07_이진화_및_임계처리.md](./07_이진화_및_임계처리.md) | HSV 기반 임계처리 |
