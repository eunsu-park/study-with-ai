[이전: 현대 딥러닝 아키텍처](./37_Modern_Architectures.md) | [다음: 실전 이미지 분류 프로젝트](./39_Practical_Image_Classification.md)
...
### 다음 단계
- Computer Vision 토픽에서 시맨틱 분할(Semantic Segmentation)을 학습합니다.
